...
namespace CareerRoadmapGenerator.Controllers
{
    public class CareersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CareerId,Title,Description")] Career career)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CareerId,Title,Description")] Career career)
        {
